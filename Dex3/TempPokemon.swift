...
// This model is used to help with the transition from the fetched data to the core data
struct TempPokemon:Codable{
    ...
    //This enum builds the structure of the JSON data using the keys. The raw values must match
    ...
    init(from decoder: Decoder) throws {
        ...
        // decoding of the types the following way since it has multiple levels
        ...
        // decoding of the stats the following way since it has multiple levels
        ...
        while !statsContainer.isAtEnd{
           ...
           // identify which stat using the name and store the values based on that
